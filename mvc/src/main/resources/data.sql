...
SELECT 'Admin', 'Premium', 'admin@premium.com', 'gmOTRSaEv8lRmI7uKMRGkg==:s/UYg36zeow6MIi7JAz9fg==', '+34 600000000', 'ADMIN', TRUE, CURRENT_TIMESTAMP
    WHERE NOT EXISTS (SELECT 1 FROM usuarios WHERE email = 'admin@premium.com');

INSERT INTO usuarios (nombre, apellidos, email, password, telefono, rol, activo, fecha_registro)
SELECT 'Charles III', 'Martín', 'carlos@premium.com', 'gmOTRSaEv8lRmI7uKMRGkg==:s/UYg36zeow6MIi7JAz9fg==', '+34 611111111', 'USER', TRUE, CURRENT_TIMESTAMP
    WHERE NOT EXISTS (SELECT 1 FROM usuarios WHERE email = 'carlos@premium.com');

INSERT INTO usuarios (nombre, apellidos, email, password, telefono, rol, activo, fecha_registro)
SELECT 'María', 'García', 'maria@premium.com', 'gmOTRSaEv8lRmI7uKMRGkg==:s/UYg36zeow6MIi7JAz9fg==', '+34 622222222', 'USER', TRUE, CURRENT_TIMESTAMP
...
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'admin@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 1'), '2026-05-28', '10:00:00', 60, 'ACTIVA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'admin@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 2'), '2026-05-05', '12:00:00', 90, 'ACTIVA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'admin@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 3'), '2026-05-15', '18:00:00', 60, 'ACTIVA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'admin@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 1'), '2026-04-20', '10:00:00', 60, 'CANCELADA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'carlos@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 1'), '2026-04-29', '09:00:00', 60, 'ACTIVA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'carlos@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 3'), '2026-05-10', '17:00:00', 90, 'ACTIVA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'carlos@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 2'), '2026-05-20', '11:00:00', 60, 'ACTIVA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'carlos@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 1'), '2026-04-15', '16:00:00', 60, 'CANCELADA', CURRENT_TIMESTAMP
...
-- Reservas para María
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'maria@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 2'), '2026-04-30', '10:00:00', 60, 'ACTIVA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'maria@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 1'), '2026-05-08', '19:00:00', 90, 'ACTIVA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'maria@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 3'), '2026-05-25', '12:00:00', 60, 'ACTIVA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'maria@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 2'), '2026-06-01', '10:00:00', 60, 'ACTIVA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'maria@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 1'), '2026-04-10', '15:00:00', 60, 'CANCELADA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'amalia@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 3'), '2026-05-22', '10:00:00', 60, 'ACTIVA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'amalia@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 1'), '2026-06-03', '16:00:00', 90, 'ACTIVA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'amalia@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 2'), '2026-06-10', '12:00:00', 60, 'ACTIVA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'amalia@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 1'), '2026-04-18', '11:00:00', 60, 'CANCELADA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'martina@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 2'), '2026-05-27', '09:00:00', 60, 'ACTIVA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'martina@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 3'), '2026-06-05', '14:00:00', 90, 'ACTIVA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'martina@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 1'), '2026-04-22', '17:00:00', 60, 'CANCELADA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'raffaella@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 1'), '2026-05-30', '11:00:00', 60, 'ACTIVA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'raffaella@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 3'), '2026-06-08', '18:00:00', 90, 'ACTIVA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'raffaella@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 2'), '2026-04-25', '10:00:00', 60, 'CANCELADA', CURRENT_TIMESTAMP
...
-- Reservas para Irene
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'irene@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 2'), '2026-06-02', '10:00:00', 60, 'ACTIVA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'irene@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 1'), '2026-06-12', '17:00:00', 90, 'ACTIVA', CURRENT_TIMESTAMP
...
INSERT INTO reservas (id_usuario, id_pista, fecha_reserva, hora_inicio, duracion_minutos, estado, fecha_creacion)
SELECT (SELECT id_usuario FROM usuarios WHERE email = 'irene@premium.com'), (SELECT id_pista FROM pistas WHERE nombre = 'Pista 3'), '2026-04-28', '12:00:00', 60, 'CANCELADA', CURRENT_TIMESTAMP
